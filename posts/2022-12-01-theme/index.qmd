...
No reason for this map aside from showcasing Quarto's content layout features, and well, I {{< bi heart size=xs >}} Russian topographic maps. Check out Soviet-era [cartography](https://www.sovietmaps.com/), it's stunning work.

This margin note uses a custom `DIV` with markdown `{.aside .shaded .mt-md-n5}`. It makes use of Boostrap's new negative margins and grid breakpoints.
:::
